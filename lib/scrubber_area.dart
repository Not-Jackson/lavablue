...
void main() {
  ...
  runApp(const ScrubberApp());
}

class ScrubberApp extends StatelessWidget {
  const ScrubberApp({super.key});
...
class ScrubberPage extends StatefulWidget {
  const ScrubberPage({super.key});

  @override
  ScrubberPageState createState() => ScrubberPageState();
}

class ScrubberPageState extends State<ScrubberPage> {
  ...
  void updatePages() {
    setState(() {
      _pages = [
        { 'name': 'Scrubber Fan 01',  'value': globals.saVars[0], 'topic': globals.saTopics[0], 'isOn': globals.saVars[0] == 'ON'},
        { 'name': 'Inlet Valve 01',  'value': globals.saVars[2], 'topic': globals.saTopics[2], 'isOn': globals.saVars[2] == 'ON'},
        { 'name': 'Scrubber Fan 02',  'value': globals.saVars[1], 'topic': globals.saTopics[1], 'isOn': globals.saVars[1] == 'ON'},
        { 'name': 'Inlet Valve 02',  'value': globals.saVars[3], 'topic': globals.saTopics[3], 'isOn': globals.saVars[3] == 'ON'},
      ];
    });
  }
  ...
  void subscribeToMqtt() async {
    ...
    subscribeToTopics(globals.saTopics);
  }
